...
def get_response(user_query: str,chat_history) -> str:
    ...
    print("***************\n","rag retriever",rag.mix_retriever("We use CBT"))
    print("***************\n","rag retriever")
...
if __name__=="__main__":
    ...
    with col_right:
        ...
        neighbor_type = "Client response" 
        fig=visualize_neo4j_subgraph(node_identity=node_id,constraint_node_properties=neighbor_type)
