...
defaut_btn_setting=[
 ...
 {
    "name": "Copy Modified Code as an Example (for last question)",
    "feather": "Play",
    "hasText": True,
    "primary": True,
    "commands": ["copyAll"],
...
#    "style": {"bottom": "0.44rem", "right": "0.4rem"}
#  },
# https://github.com/bouzidanas/streamlit.io/blob/master/streamlit-code-editor/docs/pages/4_Examples.py#L79
#  origin link has problem solve at this link ： https://discuss.streamlit.io/t/how-to-add-a-streamlit-editable-code-editor-with-python-syntax-highlighting/54473/7
#  { 
#    "name": "Submit",
#    "feather": "Play",
#    "primary": True,
